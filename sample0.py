...
async def main():
    ...
    # に変更してください
    client = DCClient(match_team_name=MatchNameModel.team0)
    ...
    print(f"client_data.team_name: {client_data.team_name}")
    print(f"client_data: {client_data}")

    await client.send_team_info(match_id, client_data)
    ...
    # team_name = await client.initialize(match_id, 0, client_data)
